...
interface IRuntimeObjects {
	...
	['DrawingCanvas']: IObjectClass<IDrawingCanvas>;
}
...
interface IDrawingCanvasVars extends VariableType {
	
}
interface IDrawingCanvasBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IDrawingCanvas extends IDrawingCanvasInstance {
	instVars: IDrawingCanvasVars;
	behaviors: IDrawingCanvasBehaviors;
}
